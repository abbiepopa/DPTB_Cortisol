...
plot(NegChange[which(NegChange$Dx =="22q"),"LogPreCort"], NegChange[which(NegChange$Dx =="22q"),"PercAngryBegin25_Angry"],col="Dark Blue", pch=20, cex=2, ylim=c(0,.5), main = "Ratio Angry Face Viewing vs. Cortisol in Reducers", xlab="Log Pre Cortisol", ylab="Ratio Angry Face Viewing - Early Trials")
...
legend(-0.42,0.5,c("Reducers with 22q", "TD Reducers", "Fit Line r=0.70", "p=0.01", "95% CI"), col=c("dark blue", "dark blue", "black",NA, "red"), pch=c(20,17, NA, NA,NA), lty=c(NA, NA, 1, NA, 2), lwd=c(NA, NA, 2,NA, 2))
...
plot(NegChange[which(NegChange$Dx =="22q"),"LogPreCort"], NegChange[which(NegChange$Dx =="22q"),"PercAngryBegin25_NonFace"],col="Dark Blue", pch=20, cex=2, ylim=c(0.1,.9), main = "Ratio NonFace Viewing vs. Cortisol in Reducers", xlab="Log Pre Cortisol", ylab="Ratio NonFace Viewing - Early Trials")
...
legend(0,.9,c("Reducers with 22q", "TD Reducers", "Fit Line r=-0.79", "p=0.002", "95% CI"), col=c("dark blue", "dark blue", "black",NA, "red"), pch=c(20,17, NA, NA,NA), lty=c(NA, NA, 1, NA, 2), lwd=c(NA, NA, 2,NA, 2))
...
plot(NegChange[which(NegChange$Dx =="22q"),"LogPreCort"], NegChange[which(NegChange$Dx =="22q"),"PercAngryBegin25_Angry"],col="Dark Blue", pch=20, cex=2, ylim=c(0,0.7), main = "Ratio Angry Face Viewing vs. Cortisol in All Participants", xlab="Log Pre Cortisol", ylab="Ratio Angry Face Viewing - Early Trials")
points(NegChange[which(NegChange$Dx =="TD"),"LogPreCort"], NegChange[which(NegChange$Dx =="TD"),"PercAngryBegin25_Angry"], col="DarkBlue", pch=17, cex=2)
...
plot(NegChange[which(NegChange$Dx =="22q"),"LogPreCort"], NegChange[which(NegChange$Dx =="22q"),"PercAngryBegin25_NonFace"],col="Dark Blue", pch=20, cex=2, ylim=c(0,1), main = "Ratio NonFace Viewing vs. Cortisol in All Participants", xlab="Log Pre Cortisol", ylab="Ratio NonFace Viewing - Early Trials")
points(NegChange[which(NegChange$Dx =="TD"),"LogPreCort"], NegChange[which(NegChange$Dx =="TD"),"PercAngryBegin25_NonFace"], col="DarkBlue", pch=17, cex=2)
...
plot(NegChange[which(NegChange$Dx =="22q"),"LogPreCort"], NegChange[which(NegChange$Dx =="22q"),"PercAngryBegin25_Angry"],col="Dark Blue", pch=20, cex=2, ylim=c(0,0.6), xlim=c(-.5,.4), main = "Early and Late Behavior in Reducers - Angry", xlab="Log Cortisol", ylab="Ratio Angry Face Viewing")
points(NegChange[which(NegChange$Dx =="TD"),"LogPreCort"], NegChange[which(NegChange$Dx =="TD"),"PercAngryBegin25_Angry"], col="DarkBlue", pch=17, cex=2)
abline(fit1, lwd=2, col="Dark Blue")
...
legend(-0.49, 0.6, c("Early r=0.61 p=0.04", "Late r=0.35 p=0.27"), pch=c(NA, NA), lty=c(1,1), lwd=c(2,2), col=c("Dark Blue", "Light Blue"))

fit2_late<-lm(NegChange$PercAngryEnd25_NonFace~NegChange$LogPostCort)

plot(NegChange[which(NegChange$Dx =="22q"),"LogPreCort"], NegChange[which(NegChange$Dx =="22q"),"PercAngryBegin25_NonFace"],col="Dark Blue", pch=20, cex=2, ylim=c(0.1,.8), xlim=c(-.5,.4), main = "Early and Late Behavior in Reducers - NonFace", xlab="Log Cortisol", ylab="Ratio Angry Face Viewing")
points(NegChange[which(NegChange$Dx =="TD"),"LogPreCort"], NegChange[which(NegChange$Dx =="TD"),"PercAngryBegin25_NonFace"], col="DarkBlue", pch=17, cex=2)
abline(fit2, lwd=2, col="Dark Blue")
...
legend(0, 0.8, c("Early r=-0.78 p=0.003", "Late r=-0.60 p=0.04"), pch=c(NA, NA), lty=c(1,1), lwd=c(2,2), col=c("Dark Blue", "Light Blue"))